...
export const CANDIDATE_ALLOWLIST = [
  ...
  'Centranthus ruber',
  // Erigeron karvinskianus intentionally excluded: naturadb.de flags it as an
  // invasive Neophyt harmful to native biodiversity, contrary to Sproutly's
  // native-first ecological positioning.
  'Scabiosa columbaria',
  'Knautia macedonica',
